...
function doRectanglesOverlap(rect1, rect2) {
  if (rect2.width < rect1.left || rect2.left > rect1.width
     || rect2.top > rect1.height || rect2.height < rect1.top) return false;
  return true;
}
...
function findFirstSingleChar(str) {
  const i = [...str].map((char) => [...str].filter((el) => el === char).length === 1);
  return i.indexOf(true) === -1 ? null : str[i.indexOf(true)];
}
